...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MyApp = __webpack_require__(159);

	var _MyApp2 = _interopRequireDefault(_MyApp);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_MyApp2.default, null), document.getElementById('app'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _AlbumsList = __webpack_require__(160);

	var _AlbumsList2 = _interopRequireDefault(_AlbumsList);

	var _AlbumImageList = __webpack_require__(162);

	var _AlbumImageList2 = _interopRequireDefault(_AlbumImageList);
	  ...
	  _createClass(MyApp, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      if (location.hash.length) {
	        ...
	        fetch("https://api.imgur.com/3/account/" + userName + "/albums/", myInit).then(function (response) {
	          return response.json();
	        }).then(function (response) {
	          _this2.setState({ albums: response.data, myInit: myInit, user: userName });
	        })

	        //using the ids of the cover images of the albums get the links of these cover images

	        .then(function () {
	          var promisesArray = _this2.state.albums.map(function (elem) {
	            return fetch("https://api.imgur.com/3/image/" + elem.cover, _this2.state.myInit).then(function (res) {
	              return res.json();
	            });
	          });
	          return Promise.all(promisesArray);
	        }).then(function (jsonsArray) {
	          var albumCoverImagesArray = [];
	          jsonsArray.forEach(function (elem) {
	            var newLink = elem.data.link.replace(elem.data.id, elem.data.id + "b");
	            albumCoverImagesArray.push({ id: elem.data.id, link: newLink });
	          });
	          albumCoverImagesArray.forEach(function (albumCover) {
	            _this2.state.albums.forEach(function (album, index) {
	              if (albumCover.id === album.cover) {
	                var newAlbumAndCover = Object.assign({}, album, { cover_link: albumCover.link });
	                var newAlbums = _this2.state.albums.slice();
	                newAlbums[index] = newAlbumAndCover;
	                _this2.setState({ albums: newAlbums });
	              }
	            });
	          });
	        })
	        ...
	        .then(function () {
	          var promisesArray = _this2.state.albums.map(function (elem) {
	            return fetch("https://api.imgur.com/3/album/" + elem.id, _this2.state.myInit).then(function (res) {
	              return res.json();
	            });
	          });
	          return Promise.all(promisesArray);
	          ...
	          var albumsImages = [];
	          jsonsArray.forEach(function (albumWithImages) {
	            albumsImages.push({ albumId: albumWithImages.data.id, images: albumWithImages.data.images });
	          });
	          albumsImages.forEach(function (albumImagesObject) {
	            _this2.state.albums.forEach(function (album, index) {
	              if (albumImagesObject.albumId === album.id) {
	        ...
	        }).catch(function catchAllErrors(error) {
	          console.log(error);
	        });
	      }
	    }
	  }, {
	    key: 'showLargeThumbnail',
	    value: function showLargeThumbnail() {
	    ...
	    value: function render() {
	      ...
	      if (this.state.selectedImage) {
	        return _react2.default.createElement(
	          'div',
	          { id: 'MyApp', className: 'container' },
	          _react2.default.createElement(
	            'button',
	            { className: 'btn btn-primary btn-lg  margin', onClick: function onClick() {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'btn btn-primary btn-lg margin', onClick: function onClick() {
	                _this3.setState({ selectedAlbum: null });
	              } },
	            'Back to All Albums'
	          ),
	        ...
	        return _react2.default.createElement(
	          'div',
	          { id: 'MyApp', className: 'container' },
	          _react2.default.createElement(_AlbumsList2.default, {
	            onAlbumSelect: function onAlbumSelect(selectedAlbum) {
	              _this3.setState({ selectedAlbum: selectedAlbum });
	            },
	        ...
	        return _react2.default.createElement(
	          'div',
	          { className: 'myWrapper container' },
	          _react2.default.createElement('div', { className: 'row spacer' }),
	          _react2.default.createElement(
	            'a',
	            { id: 'link', href: 'https://api.imgur.com/oauth2/authorize?client_id=def28988449063f&response_type=token' },
	            _react2.default.createElement(
	              'button',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Album = __webpack_require__(161);
	...
	var AlbumsList = function (_React$Component) {
	  _inherits(AlbumsList, _React$Component);

	  function AlbumsList(props) {
	    _classCallCheck(this, AlbumsList);

	    var _this = _possibleConstructorReturn(this, (AlbumsList.__proto__ || Object.getPrototypeOf(AlbumsList)).call(this, props));

	    _this.renderAlbums = _this.renderAlbums.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(AlbumsList, [{
	    ...
	    value: function renderAlbums() {
	      ...
	      return this.props.albums.map(function (album, idx) {
	        return _react2.default.createElement(_Album2.default, {
	          onAlbumSelect: _this2.props.onAlbumSelect,
	          key: idx,
	          album: album });
	      });
	    }
	      ...
	      return _react2.default.createElement(
	        ...
	        { className: "grid-item",
	          onClick: function onClick() {
	            _this2.props.onAlbumSelect(_this2.props.album);
	          } },
	        _react2.default.createElement(
	          "div",
	          { className: "panel" },
	          _react2.default.createElement("img", { className: "img-thumbnail", src: this.props.album.cover_link }),
	          _react2.default.createElement(
	            "h4",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Image = __webpack_require__(163);
	...
	var AlbumImageList = function (_React$Component) {
	  _inherits(AlbumImageList, _React$Component);

	  function AlbumImageList(props) {
	    _classCallCheck(this, AlbumImageList);

	    var _this = _possibleConstructorReturn(this, (AlbumImageList.__proto__ || Object.getPrototypeOf(AlbumImageList)).call(this, props));

	    _this.renderImages = _this.renderImages.bind(_this);
	    return _this;
	  }

	  _createClass(AlbumImageList, [{
	    key: 'renderImages',
	    value: function renderImages() {
	      ...
	      return this.props.images.map(function (image, idx) {
	        ...
	        return _react2.default.createElement(_Image2.default, {
	          onImageSelect: _this2.props.onImageSelect,
	          key: idx,
	          index: idx,
	...
	exports.default = AlbumImageList;
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "panel" },
	          _react2.default.createElement("img", { className: "img-thumbnail", src: this.props.thumbnailUrl }),
